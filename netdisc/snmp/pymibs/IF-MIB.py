...
MibIdentifier, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, TimeTicks, ModuleIdentity, NotificationType, Bits, ObjectIdentity, Counter32, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "ObjectIdentity", "Counter32", "Integer32", "iso", "Unsigned32")
TestAndIncr, DisplayString, TextualConvention, TimeStamp, PhysAddress, TruthValue, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "TextualConvention", "TimeStamp", "PhysAddress", "TruthValue", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifFixedLengthGroup=ifFixedLengthGroup, ifHCInOctets=ifHCInOctets, ifMtu=ifMtu, ifInOctets=ifInOctets, ifCompliances=ifCompliances, ifXTable=ifXTable, ifSpecific=ifSpecific, ifTestId=ifTestId, ifStackTable=ifStackTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifDescr=ifDescr, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackStatus=ifStackStatus, ifOutDiscards=ifOutDiscards, ifConformance=ifConformance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestTable=ifTestTable, ifOutMulticastPkts=ifOutMulticastPkts, ifHighSpeed=ifHighSpeed, ifInBroadcastPkts=ifInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackGroup=ifStackGroup, ifOutOctets=ifOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifAlias=ifAlias, ifRcvAddressAddress=ifRcvAddressAddress, ifIndex=ifIndex, linkDown=linkDown, ifCompliance2=ifCompliance2, ifMIBObjects=ifMIBObjects, ifName=ifName, ifCompliance3=ifCompliance3, ifHCInUcastPkts=ifHCInUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifTestEntry=ifTestEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifNumber=ifNumber, ifStackHigherLayer=ifStackHigherLayer, ifGroups=ifGroups, ifTableLastChange=ifTableLastChange, ifPhysAddress=ifPhysAddress, ifTable=ifTable, ifSpeed=ifSpeed, ifInUcastPkts=ifInUcastPkts, ifInErrors=ifInErrors, ifRcvAddressType=ifRcvAddressType, ifGeneralInformationGroup=ifGeneralInformationGroup, ifPacketGroup=ifPacketGroup, ifOutErrors=ifOutErrors, ifRcvAddressGroup=ifRcvAddressGroup, ifOutQLen=ifOutQLen, ifCompliance=ifCompliance, PYSNMP_MODULE_ID=ifMIB, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifGeneralGroup=ifGeneralGroup, ifInNUcastPkts=ifInNUcastPkts, interfaces=interfaces, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestStatus=ifTestStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifEntry=ifEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, OwnerString=OwnerString, ifRcvAddressTable=ifRcvAddressTable, ifType=ifType, ifTestResult=ifTestResult, ifTestType=ifTestType, ifOperStatus=ifOperStatus, ifStackLastChange=ifStackLastChange, ifInDiscards=ifInDiscards, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndex=InterfaceIndex, ifOutNUcastPkts=ifOutNUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifAdminStatus=ifAdminStatus, ifPromiscuousMode=ifPromiscuousMode, ifStackEntry=ifStackEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCPacketGroup=ifHCPacketGroup, ifStackGroup2=ifStackGroup2, ifLastChange=ifLastChange, ifInUnknownProtos=ifInUnknownProtos, ifMIB=ifMIB, ifHCOutOctets=ifHCOutOctets, ifConnectorPresent=ifConnectorPresent, ifRcvAddressStatus=ifRcvAddressStatus, ifTestOwner=ifTestOwner, linkUp=linkUp, ifXEntry=ifXEntry, ifTestGroup=ifTestGroup, ifTestCode=ifTestCode)
