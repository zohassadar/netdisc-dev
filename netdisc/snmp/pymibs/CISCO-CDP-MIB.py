...
Counter32, MibIdentifier, IpAddress, Counter64, Gauge32, TimeTicks, ModuleIdentity, NotificationType, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "IpAddress", "Counter64", "Gauge32", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("CISCO-CDP-MIB", cdpCacheNativeVLAN=cdpCacheNativeVLAN, ciscoCdpMIBObjects=ciscoCdpMIBObjects, cdpCachePrimaryMgmtAddrType=cdpCachePrimaryMgmtAddrType, ciscoCdpMIBComplianceV12R02=ciscoCdpMIBComplianceV12R02, ciscoCdpMIBGroupV11R01=ciscoCdpMIBGroupV11R01, cdpInterfaceEnable=cdpInterfaceEnable, cdpCtAddressTable=cdpCtAddressTable, cdpGlobalDeviceIdFormatCpb=cdpGlobalDeviceIdFormatCpb, cdpInterfacePort=cdpInterfacePort, cdpCacheSecondaryMgmtAddr=cdpCacheSecondaryMgmtAddr, ciscoCdpMIBGroupV11R02=ciscoCdpMIBGroupV11R02, cdpGlobalDeviceIdFormat=cdpGlobalDeviceIdFormat, cdpGlobalMessageInterval=cdpGlobalMessageInterval, ciscoCdpMIBCompliance=ciscoCdpMIBCompliance, cdpCacheLastChange=cdpCacheLastChange, ciscoCdpMIBComplianceV11R01=ciscoCdpMIBComplianceV11R01, cdpCacheIfIndex=cdpCacheIfIndex, cdpInterfaceIfIndex=cdpInterfaceIfIndex, cdpInterfaceTable=cdpInterfaceTable, cdpCacheDevicePort=cdpCacheDevicePort, PYSNMP_MODULE_ID=ciscoCdpMIB, cdpCachePrimaryMgmtAddr=cdpCachePrimaryMgmtAddr, cdpCachePhysLocation=cdpCachePhysLocation, cdpGlobalRun=cdpGlobalRun, ciscoCdpMIBGroupV12R03=ciscoCdpMIBGroupV12R03, cdpCtAddressEntry=cdpCtAddressEntry, cdpCacheSysName=cdpCacheSysName, cdpInterfaceCosForUntrustedPort=cdpInterfaceCosForUntrustedPort, cdpCacheMTU=cdpCacheMTU, cdpCtAddressIndex=cdpCtAddressIndex, cdpInterfaceGroup=cdpInterfaceGroup, cdpCacheDuplex=cdpCacheDuplex, ciscoCdpMIBGroups=ciscoCdpMIBGroups, ciscoCdpMIB=ciscoCdpMIB, ciscoCdpMIBCompliance5=ciscoCdpMIBCompliance5, ciscoCdpCtAddressGroup=ciscoCdpCtAddressGroup, cdpCacheSecondaryMgmtAddrType=cdpCacheSecondaryMgmtAddrType, cdpInterfaceEntry=cdpInterfaceEntry, ciscoCdpMIBComplianceV12R03=ciscoCdpMIBComplianceV12R03, cdpInterfaceExtTable=cdpInterfaceExtTable, cdpCtAddress=cdpCtAddress, ciscoCdpMIBComplianceV11R02=ciscoCdpMIBComplianceV11R02, cdpInterfaceMessageInterval=cdpInterfaceMessageInterval, cdpCachePlatform=cdpCachePlatform, cdpGlobalDeviceId=cdpGlobalDeviceId, ciscoCdpMIBCompliances=ciscoCdpMIBCompliances, ciscoCdpMIBGroupV12R02=ciscoCdpMIBGroupV12R02, cdpCacheVersion=cdpCacheVersion, cdpCacheTable=cdpCacheTable, cdpInterface=cdpInterface, cdpGlobalLastChange=cdpGlobalLastChange, ciscoCdpV2MIBGroup=ciscoCdpV2MIBGroup, ciscoCdpMIBConformance=ciscoCdpMIBConformance, cdpCacheAddressType=cdpCacheAddressType, cdpCacheApplianceID=cdpCacheApplianceID, cdpCacheVTPMgmtDomain=cdpCacheVTPMgmtDomain, cdpGlobalHoldTime=cdpGlobalHoldTime, cdpInterfaceExtEntry=cdpInterfaceExtEntry, cdpCacheCapabilities=cdpCacheCapabilities, cdpCacheDeviceId=cdpCacheDeviceId, cdpCacheAddress=cdpCacheAddress, cdpCacheEntry=cdpCacheEntry, cdpCacheDeviceIndex=cdpCacheDeviceIndex, cdpCacheVlanID=cdpCacheVlanID, cdpInterfaceName=cdpInterfaceName, cdpCachePowerConsumption=cdpCachePowerConsumption, cdpCacheSysObjectID=cdpCacheSysObjectID, ciscoCdpMIBGroup=ciscoCdpMIBGroup, cdpCache=cdpCache, cdpInterfaceExtendedTrust=cdpInterfaceExtendedTrust, cdpCtAddressType=cdpCtAddressType, ciscoCdpV2IfExtGroup=ciscoCdpV2IfExtGroup, cdpGlobal=cdpGlobal)
