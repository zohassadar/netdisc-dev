...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Bits, NotificationType, ModuleIdentity, TimeTicks, ObjectIdentity, IpAddress, iso, mib_2, Unsigned32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Bits", "NotificationType", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "IpAddress", "iso", "mib-2", "Unsigned32", "Counter32", "Counter64")
