...
# ASN.1 source file:///mibs.thola.io/asn1/CISCO-TC
...
MibIdentifier, IpAddress, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, NotificationType, Bits, ObjectIdentity, Counter32, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "ObjectIdentity", "Counter32", "Integer32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("CISCO-TC", CiscoPortListRange=CiscoPortListRange, CountryCode=CountryCode, BulkConfigResult=BulkConfigResult, CiscoLocationSpecifier=CiscoLocationSpecifier, CiscoMilliSeconds=CiscoMilliSeconds, CiscoURLString=CiscoURLString, CiscoNetworkAddress=CiscoNetworkAddress, EntLogicalIndexOrZero=EntLogicalIndexOrZero, CiscoHTTPResponseStatusCode=CiscoHTTPResponseStatusCode, TimeIntervalSec=TimeIntervalSec, EntPhysicalIndexOrZero=EntPhysicalIndexOrZero, CiscoRowOperStatus=CiscoRowOperStatus, CountryCodeITU=CountryCodeITU, CiscoEntityIndexList=CiscoEntityIndexList, MicroSeconds=MicroSeconds, Layer2Cos=Layer2Cos, CiscoVlanList=CiscoVlanList, CiscoVrfName=CiscoVrfName, CiscoAlarmSeverity=CiscoAlarmSeverity, CiscoPort=CiscoPort, ConfigIterator=ConfigIterator, CiscoURLStringOrEmpty=CiscoURLStringOrEmpty, CiscoAbsZeroBasedCounter64=CiscoAbsZeroBasedCounter64, CiscoIpProtocol=CiscoIpProtocol, CiscoAbsZeroBasedCounter32=CiscoAbsZeroBasedCounter32, InterfaceIndexOrZero=InterfaceIndexOrZero, Unsigned64=Unsigned64, PerfHighIntervalCount=PerfHighIntervalCount, CiscoCosList=CiscoCosList, TimeIntervalMin=TimeIntervalMin, SAPType=SAPType, CiscoSnapShotAbsCounter32=CiscoSnapShotAbsCounter32, PYSNMP_MODULE_ID=ciscoTextualConventions, CiscoInterfaceIndexList=CiscoInterfaceIndexList, ListIndex=ListIndex, CiscoInetAddressMask=CiscoInetAddressMask, CiscoLocationClass=CiscoLocationClass, CiscoVlanIndex=CiscoVlanIndex, CiscoNetworkProtocol=CiscoNetworkProtocol, CiscoBridgeDomain=CiscoBridgeDomain, IfOperStatusReason=IfOperStatusReason, CiscoPortList=CiscoPortList, ListIndexOrZero=ListIndexOrZero, CvE164Address=CvE164Address, Cisco2KVlanList=Cisco2KVlanList, ciscoTextualConventions=ciscoTextualConventions, CiscoPbbServiceIdentifier=CiscoPbbServiceIdentifier)
