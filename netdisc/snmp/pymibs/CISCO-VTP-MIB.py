...
MibIdentifier, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, ModuleIdentity, NotificationType, Bits, ObjectIdentity, Counter32, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "ObjectIdentity", "Counter32", "Integer32", "iso", "Unsigned32")
TestAndIncr, DisplayString, TextualConvention, TimeStamp, TruthValue, DateAndTime, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "TextualConvention", "TimeStamp", "TruthValue", "DateAndTime", "RowStatus")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vtpVlanTypeExt=vtpVlanTypeExt, vtpPruningStateOperChange=vtpPruningStateOperChange, managementDomainTftpServer=managementDomainTftpServer, vtpStats=vtpStats, vtpServerDisabled=vtpServerDisabled, vtpVlanEditDot10Said=vtpVlanEditDot10Said, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vtpMIBCompliance4=vtpMIBCompliance4, vtpVlanIndex=vtpVlanIndex, managementDomainDeviceID=managementDomainDeviceID, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vtpConfigNotificationsGroup7=vtpConfigNotificationsGroup7, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpVlanDot10Said=vtpVlanDot10Said, vtpInAdvertRequests=vtpInAdvertRequests, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vtpMIBCompliance8=vtpMIBCompliance8, vtpDatabaseName=vtpDatabaseName, vtpTrunkPortGroup=vtpTrunkPortGroup, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpOutAdvertRequests=vtpOutAdvertRequests, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vtpVlanMtu=vtpVlanMtu, vtpVlanTable=vtpVlanTable, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpConfigDigestError=vtpConfigDigestError, vtpMtuTooBig=vtpMtuTooBig, vtpVlanEditType=vtpVlanEditType, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vlanInfo=vlanInfo, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vtpDiscover=vtpDiscover, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpVlanEditState=vtpVlanEditState, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vlanTrunkPorts=vlanTrunkPorts, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, managementDomainSourceOnlyMode=managementDomainSourceOnlyMode, vlanTrunkPortActiveVlansGroup=vlanTrunkPortActiveVlansGroup, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vlanTrunkPortEntry=vlanTrunkPortEntry, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vtpDatabaseEntry=vtpDatabaseEntry, internalVlanInfo=internalVlanInfo, vlanStatistics=vlanStatistics, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpTrunkPruningGroup3=vtpTrunkPruningGroup3, vlanTrunkPortVlansActiveSecond2k=vlanTrunkPortVlansActiveSecond2k, vtpTrunkPortGroup2=vtpTrunkPortGroup2, managementDomainLastChange=managementDomainLastChange, managementDomainPruningState=managementDomainPruningState, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpMIBCompliance16=vtpMIBCompliance16, vtpVlanStpType=vtpVlanStpType, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpMIBCompliance14=vtpMIBCompliance14, vtp4kVlanGroup=vtp4kVlanGroup, vtpVlanName=vtpVlanName, vtpDatabaseGroup=vtpDatabaseGroup, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpStatus=vtpStatus, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpSourceInterfaceGroup=vtpSourceInterfaceGroup, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vtpVlanSteHopCount=vtpVlanSteHopCount, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtpVlanLocalShutdownGroup=vtpVlanLocalShutdownGroup, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpNotifications=vtpNotifications, vtpAuthEntry=vtpAuthEntry, managementDomainPruningStateOper=managementDomainPruningStateOper, vtpVlanBridgeType=vtpVlanBridgeType, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, PYSNMP_MODULE_ID=ciscoVtpMIB, vtpVlanLocalShutdown=vtpVlanLocalShutdown, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpDiscoverEntry=vtpDiscoverEntry, VlanTypeExt=VlanTypeExt, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vtpVlanEditIndex=vtpVlanEditIndex, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpMIBObjects=vtpMIBObjects, vtpInternalVlanGrp=vtpInternalVlanGrp, managementDomainLocalMode=managementDomainLocalMode, vtpInSubsetAdverts=vtpInSubsetAdverts, vtpMIBCompliance12=vtpMIBCompliance12, vtpDiscoverTable=vtpDiscoverTable, vtpVlanEntry=vtpVlanEntry, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, managementDomainIndex=managementDomainIndex, vtpVlanEditName=vtpVlanEditName, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpMIBCompliance=vtpMIBCompliance, vlanStatsGroup=vlanStatsGroup, vtpConfigFileGroup=vtpConfigFileGroup, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtpDiscoverStatus=vtpDiscoverStatus, vtpVlanEditRingNumber=vtpVlanEditRingNumber, vtpLocalUpdaterGroup=vtpLocalUpdaterGroup, vtpConfigNotificationsGroup8=vtpConfigNotificationsGroup8, vtpAuthentication=vtpAuthentication, vlanStatsVlans=vlanStatsVlans, vtpBasicGroup=vtpBasicGroup, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vlanTrunkPortVlansActiveFirst2k=vlanTrunkPortVlansActiveFirst2k, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpAuthSecretKey=vtpAuthSecretKey, vtpInternalVlanTable=vtpInternalVlanTable, vtpMIBGroups=vtpMIBGroups, vtpInternalVlanEntry=vtpInternalVlanEntry, vtpVlanEditOperation=vtpVlanEditOperation, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpMIBCompliance15=vtpMIBCompliance15, vtpConfigNotificationsGroup6=vtpConfigNotificationsGroup6, ciscoVtpMIB=ciscoVtpMIB, vtpStatsGroup=vtpStatsGroup, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpVlanType=vtpVlanType, vtpVlanRingNumber=vtpVlanRingNumber, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, managementDomainVersionInUse=managementDomainVersionInUse, vtpStatsTable=vtpStatsTable, vtpVlanLocalShutdownTable=vtpVlanLocalShutdownTable, vlanStatsFreeVlans=vlanStatsFreeVlans, vtpDatabaseTable=vtpDatabaseTable, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vlanManagementDomains=vlanManagementDomains, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, managementDomainTable=managementDomainTable, vtpDiscoverAction=vtpDiscoverAction, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vtpVlanState=vtpVlanState, vtpVlanParentVlan=vtpVlanParentVlan, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpLocalModeChanged=vtpLocalModeChanged, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vtpMIBCompliance3=vtpMIBCompliance3, vtpAuthPassword=vtpAuthPassword, vtpDiscoverGroup=vtpDiscoverGroup, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vtpNotificationsEnabled=vtpNotificationsEnabled, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpNotificationsObjects=vtpNotificationsObjects, ManagementDomainIndex=ManagementDomainIndex, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, vtpVersion=vtpVersion, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, managementDomainName=managementDomainName, managementDomainOperSrcIf=managementDomainOperSrcIf, managementDomainEntry=managementDomainEntry, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpTrunkPruningGroup=vtpTrunkPruningGroup, VlanType=VlanType, vlanEdit=vlanEdit, vtpVlanDeleted=vtpVlanDeleted, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vtpMIBCompliance10=vtpMIBCompliance10, managementDomainLocalUpdater=managementDomainLocalUpdater, vtpEditControlTable=vtpEditControlTable, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpMIBCompliance7=vtpMIBCompliance7, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vlanStatsExtendedVlans=vlanStatsExtendedVlans, managementDomainLocalUpdaterType=managementDomainLocalUpdaterType, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpMIBCompliance6=vtpMIBCompliance6, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vtpVlanEditEntry=vtpVlanEditEntry, vtpMIBCompliances=vtpMIBCompliances, vlanStatsInternalVlans=vlanStatsInternalVlans, vtpDatabaseLocalMode=vtpDatabaseLocalMode, managementDomainTftpPathname=managementDomainTftpPathname, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpMIBConformance=vtpMIBConformance, vtpStatsEntry=vtpStatsEntry, vtpMIBCompliance5=vtpMIBCompliance5, vtpVlanEditStpType=vtpVlanEditStpType, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vtpDeviceIdGroup=vtpDeviceIdGroup, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpMaxVlanStorage=vtpMaxVlanStorage, managementDomainAdminSrcIf=managementDomainAdminSrcIf, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vtpAuthPasswordType=vtpAuthPasswordType, vtpDatabaseIndex=vtpDatabaseIndex, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, VlanIndex=VlanIndex, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpMIBCompliance2=vtpMIBCompliance2, managementDomainConfigFile=managementDomainConfigFile, vlanTrunkPortTable=vlanTrunkPortTable, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpAuthGroup=vtpAuthGroup, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpVlanLocalShutdownEntry=vtpVlanLocalShutdownEntry, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpDatabase=vtpDatabase, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, managementDomainRowStatus=managementDomainRowStatus, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vtpMIBCompliance13=vtpMIBCompliance13, vtpVlanEditMtu=vtpVlanEditMtu, vtpAuthenticationTable=vtpAuthenticationTable, vtpMIBCompliance11=vtpMIBCompliance11, managementDomainLastUpdater=managementDomainLastUpdater, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vtpVlanIfIndex=vtpVlanIfIndex, vtpMIBCompliance9=vtpMIBCompliance9, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpEditControlEntry=vtpEditControlEntry, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpVlanCreated=vtpVlanCreated, vtpVlanInfoGroup=vtpVlanInfoGroup, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vtpVlanEditTable=vtpVlanEditTable, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpVlanApplyStatus=vtpVlanApplyStatus, vtpInternalVlanOwner=vtpInternalVlanOwner)
