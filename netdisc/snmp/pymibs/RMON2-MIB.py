...
etherStatsEntry, channelEntry, history, matrix, hostControlEntry, OwnerString, statistics, filterEntry, hosts, historyControlEntry, matrixControlEntry, filter = mibBuilder.importSymbols("RMON-MIB", "etherStatsEntry", "channelEntry", "history", "matrix", "hostControlEntry", "OwnerString", "statistics", "filterEntry", "hosts", "historyControlEntry", "matrixControlEntry", "filter")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Integer32, Bits, NotificationType, ModuleIdentity, TimeTicks, ObjectIdentity, iso, mib_2, IpAddress, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Integer32", "Bits", "NotificationType", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "iso", "mib-2", "IpAddress", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("RMON2-MIB", ZeroBasedCounter32=ZeroBasedCounter32, addressMap=addressMap, protocolDist=protocolDist, usrHistory=usrHistory, rmon=rmon, nlHost=nlHost, protocolDir=protocolDir, probeConfig=probeConfig, alHost=alHost, TimeFilter=TimeFilter, DataSource=DataSource, alMatrix=alMatrix, PYSNMP_MODULE_ID=rmon, LastCreateTime=LastCreateTime, nlMatrix=nlMatrix, rmonConformance=rmonConformance)
