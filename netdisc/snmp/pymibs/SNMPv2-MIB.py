...
snmpModules, ModuleIdentity, MibIdentifier, NotificationType, Counter64, iso, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, IpAddress, ObjectIdentity, mib_2, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "ModuleIdentity", "MibIdentifier", "NotificationType", "Counter64", "iso", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "IpAddress", "ObjectIdentity", "mib-2", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpInPkts=snmpInPkts, snmpTraps=snmpTraps, sysDescr=sysDescr, snmpInNoSuchNames=snmpInNoSuchNames, sysLocation=sysLocation, snmpInTotalReqVars=snmpInTotalReqVars, snmpOutPkts=snmpOutPkts, snmpObsoleteGroup=snmpObsoleteGroup, snmpInTooBigs=snmpInTooBigs, snmpInGetResponses=snmpInGetResponses, snmpInASNParseErrs=snmpInASNParseErrs, snmpSetSerialNo=snmpSetSerialNo, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpInGetNexts=snmpInGetNexts, snmpMIBObjects=snmpMIBObjects, snmpTrapOID=snmpTrapOID, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpCommunityGroup=snmpCommunityGroup, sysORIndex=sysORIndex, sysUpTime=sysUpTime, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpOutSetRequests=snmpOutSetRequests, sysOREntry=sysOREntry, snmpOutTraps=snmpOutTraps, snmpInBadValues=snmpInBadValues, snmpOutGetRequests=snmpOutGetRequests, snmpOutGenErrs=snmpOutGenErrs, snmpOutBadValues=snmpOutBadValues, sysORLastChange=sysORLastChange, sysObjectID=sysObjectID, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpGroup=snmpGroup, snmpOutTooBigs=snmpOutTooBigs, warmStart=warmStart, snmpTrap=snmpTrap, snmpProxyDrops=snmpProxyDrops, snmpMIBConformance=snmpMIBConformance, snmpMIBGroups=snmpMIBGroups, sysServices=sysServices, snmpOutGetNexts=snmpOutGetNexts, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpMIB=snmpMIB, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpTrapEnterprise=snmpTrapEnterprise, snmpInReadOnlys=snmpInReadOnlys, snmpOutGetResponses=snmpOutGetResponses, sysName=sysName, sysORDescr=sysORDescr, snmpNotificationGroup=snmpNotificationGroup, snmpInBadCommunityUses=snmpInBadCommunityUses, sysContact=sysContact, systemGroup=systemGroup, snmpInTotalSetVars=snmpInTotalSetVars, snmpInGenErrs=snmpInGenErrs, snmpInSetRequests=snmpInSetRequests, authenticationFailure=authenticationFailure, snmpSilentDrops=snmpSilentDrops, coldStart=coldStart, snmpInGetRequests=snmpInGetRequests, snmpInTraps=snmpInTraps, sysORTable=sysORTable, snmpSet=snmpSet, system=system, snmpInBadVersions=snmpInBadVersions, snmpMIBCompliances=snmpMIBCompliances, PYSNMP_MODULE_ID=snmpMIB, snmpBasicCompliance=snmpBasicCompliance, snmpSetGroup=snmpSetGroup, sysORID=sysORID, sysORUpTime=sysORUpTime, snmp=snmp)
